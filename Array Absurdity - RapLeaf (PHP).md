...
If 5:**0,1,2,3,3** is 5-digits long, the length is 5, or **n = 5**. If the **actual sum** of 0 + 1 + 2 + 3 + 3 = **9** and the expected sum is equal to:

0 + 1 + 2 + 3 = **6** &nbsp;&nbsp;which is the same as&nbsp;&nbsp; **( (n - 2) x (n - 1) ) / 2** = **6** &nbsp;&nbsp;&nbsp; when n = 5, we know a **3** must be repeated. See the "3 Repeats" column below
