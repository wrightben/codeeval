...
The book above shows that the sum of a sequence beginning with 0 (like 0,1,2,3) is: *( 3 x (3 + 1) ) / 2*. This is the *expected sum*–the sum expected when no digits are repeated.
