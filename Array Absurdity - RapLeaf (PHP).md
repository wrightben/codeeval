...
0 + 1 + 2 + 3 = **6** &nbsp;&nbsp;which is the same as&nbsp;&nbsp; **( (n - 2) x (n - 1) ) / 2**

If 0 + 1 + 2 + 3 + 3 = **9** and **( (n - 2) x (n - 1) ) / 2** = **6**, we know the 3 must be repeated when we subtract the 6 from the 9 as shown below.
