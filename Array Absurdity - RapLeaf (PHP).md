...
Imagine we have an immutable array of size *n* which we know to be filled with numbers ranging from 0 to (n - 2). The array contains exactly one duplicate number. Find it. (Bonus: Create a solution with constant space and time proportional to n.)
