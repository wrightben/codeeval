...
Robot considers blocked paths. Robot chooses paths randomly, but it can recognize when it's about to repeat a mistake. If it encounters a recognizable do-over scenario, it attempts to make a better choice.
