...
Robot considers blocked paths. Robot chooses paths randomly, but it can recognize when it's about to repeat a mistake. If it has an option to make a different choice, it does so.
