...
#### Notes
* Nested for-loops: ./code/perl/iter.pl generates a conventional nested for-loop structure. It's *way* more efficient than my algorithm, but still iterates over n^n numbers where n = r.
