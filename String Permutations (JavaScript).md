...
Each letter of a *word* has a *numerical position* within the word. The words *c-a-t*, *d-o-g*, and *p-e-t* are each equal to *1-2-3*, so it isn't necessary to generate permutations of letters for each word. The letters of any word can replace the digits of the numerical sequence of the same length.
